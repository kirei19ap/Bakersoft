...
-- Tiempo de generación: 14-12-2025 a las 19:25:21
...
--
-- Estructura de tabla para la tabla `asignacionturnos`
--

DROP TABLE IF EXISTS `asignacionturnos`;
CREATE TABLE IF NOT EXISTS `asignacionturnos` (
  ...
  UNIQUE KEY `uniq_empleado_turno_fecha` (`idEmpleado`,`idTurno`,`fecha`),
  KEY `idx_fecha_turno` (`fecha`,`idTurno`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Volcado de datos para la tabla `asignacionturnos`
--
...
(3, 12, 1, '2025-12-03', 'Cancelado', '2025-12-11 11:12:02', 0),
(4, 12, 1, '2025-12-04', 'Asignado', '2025-12-03 14:54:20', 0),
(5, 11, 1, '2025-12-05', 'Finalizado', '2025-12-08 16:48:25', 0),
(6, 11, 1, '2025-12-06', 'Finalizado', '2025-12-11 11:37:57', 0),
(7, 11, 1, '2025-12-07', 'Finalizado', '2025-12-11 11:37:59', 0),
(8, 14, 3, '2025-12-14', 'Asignado', '2025-12-11 11:37:00', 0),
(9, 11, 3, '2025-12-16', 'Asignado', '2025-12-04 13:39:23', 0),
(10, 14, 3, '2025-12-18', 'Cancelado', '2025-12-08 16:35:50', 0),
(11, 11, 2, '2025-12-15', 'Confirmado', '2025-12-11 11:37:44', 0),
(12, 12, 2, '2025-12-16', 'Cancelado', '2025-12-11 11:13:35', 0),
(13, 12, 2, '2025-12-17', 'Asignado', '2025-12-11 11:13:35', 0),
(14, 12, 2, '2025-12-18', 'Asignado', '2025-12-11 11:13:35', 0),
(15, 12, 2, '2025-12-19', 'Asignado', '2025-12-11 11:13:35', 0),
(16, 12, 2, '2025-12-20', 'Asignado', '2025-12-11 11:13:35', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `categoriamp`
--
...
--
-- Volcado de datos para la tabla `categoriamp`
--
...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  KEY `fk_cliente_localidad` (`localidad`),
  KEY `idx_clientes_busqueda` (`nombre`,`email`,`telefono`)
...
(8, 'Panaderia Susi', 'susi@gmail.com', '46962285', 'Navarro', 1346, 1, 1, 'Activo'),
(9, 'La Nueva Pompeya', 'lanueva@gmail.com', '43218569', 'San Martin', 2396, 1, 1, 'Activo'),
(10, 'Los Andes', 'andes@gmail.com', '4632325', 'Garita', 2514, 1, 1, 'Activo'),
(11, 'Supermercado Argentina', 'super_arg@gmail.com', '4218369', 'Viamonte', 3614, 1, 1, 'Activo');
...
CREATE TABLE IF NOT EXISTS `detallepedidoventa` (
  `idDetallePedidoVenta` int NOT NULL AUTO_INCREMENT,
  `idPedidoVenta` int NOT NULL,
  `idProducto` int NOT NULL,
  `cantidad` decimal(10,2) NOT NULL,
  `precioUnitario` decimal(10,2) NOT NULL,
  `subtotal` decimal(10,2) NOT NULL,
  PRIMARY KEY (`idDetallePedidoVenta`),
  KEY `fk_detalle_pedidoventa_pedido` (`idPedidoVenta`),
  KEY `fk_detalle_pedidoventa_producto` (`idProducto`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Volcado de datos para la tabla `detallepedidoventa`
--
...
(19, 7, 1, 20.00, 1500.00, 30000.00),
(20, 7, 4, 15.00, 1700.00, 25500.00),
(21, 8, 2, 20.00, 1800.00, 36000.00),
(22, 8, 6, 6.00, 15000.00, 90000.00),
(23, 9, 1, 25.00, 1500.00, 37500.00),
(24, 10, 2, 15.00, 1800.00, 27000.00),
(27, 11, 2, 1.00, 1800.00, 1800.00),
(28, 11, 3, 1.00, 950.00, 950.00),
(29, 12, 3, 10.00, 950.00, 9500.00),
(30, 12, 2, 20.00, 1800.00, 36000.00),
(31, 13, 8, 5.00, 3500.00, 17500.00),
(32, 14, 8, 1.00, 3500.00, 3500.00),
(33, 15, 8, 6.00, 3500.00, 21000.00),
(34, 16, 3, 10.00, 950.00, 9500.00),
(35, 17, 7, 1.00, 8500.00, 8500.00);
...
--
-- Estructura de tabla para la tabla `detallereparto`
--

DROP TABLE IF EXISTS `detallereparto`;
CREATE TABLE IF NOT EXISTS `detallereparto` (
  `idDetalleReparto` int NOT NULL AUTO_INCREMENT,
  `idReparto` int NOT NULL,
  `idPedidoVenta` int NOT NULL,
  `ordenEntrega` int DEFAULT NULL,
  `estadoEntrega` enum('Pendiente','Entregado','No Entregado','Reprogramado') NOT NULL DEFAULT 'Pendiente',
  PRIMARY KEY (`idDetalleReparto`),
  KEY `idx_detallereparto_reparto` (`idReparto`),
  KEY `idx_detallereparto_pedido` (`idPedidoVenta`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Volcado de datos para la tabla `detallereparto`
--

INSERT INTO `detallereparto` (`idDetalleReparto`, `idReparto`, `idPedidoVenta`, `ordenEntrega`, `estadoEntrega`) VALUES
(2, 2, 11, 1, 'Entregado'),
(3, 3, 14, 1, 'Entregado'),
(4, 4, 15, 1, 'Entregado'),
(5, 4, 16, 2, 'Entregado');
...
--
-- Estructura de tabla para la tabla `detalle_licencia`
--
...
--
-- Volcado de datos para la tabla `detalle_licencia`
--
...
(10, 'Facundo', 'Baldomir', 'Masculino', 1, '2014-12-22', '54455740', '27544557403', '1325', 'facu@gmail.com', '42523363', 'Casablanca 1725', 2, 154, '2025-09-24', 1, 'Activo', 0, NULL, 26),
...
(12, 'Beatriz', 'Sanchez', 'Femenino', 2, '1974-11-19', '19252369', '27192523694', '0621', 'beatriz@gmail.com', '0351-693214', 'Juarez 1524', 7, 495, '2014-08-04', 5, 'Activo', 0, NULL, 30),
...
(18, 'Pedro', 'Varela', 'Masculino', 2, '1973-07-17', '18462353', '20184623531', '1527', 'pvarela@gmail.com', '0351-4249685', 'Guatemala 2519', 7, 554, '2016-10-10', 11, 'Activo', 0, NULL, 29);
...
--
-- Estructura de tabla para la tabla `estados_licencia`
--
...
--
-- Volcado de datos para la tabla `estados_licencia`
--
...
--
-- Estructura de tabla para la tabla `licencia_cambios`
--
...
--
-- Volcado de datos para la tabla `licencia_cambios`
--
...
--
-- Estructura de tabla para la tabla `licencia_politicas_global`
--

DROP TABLE IF EXISTS `licencia_politicas_global`;
CREATE TABLE IF NOT EXISTS `licencia_politicas_global` (
  `id_tipo` int NOT NULL,
...
--
-- Volcado de datos para la tabla `licencia_politicas_global`
--
...
(18, 'Harina', '', 'kg', 1, NULL, 100, 350, 26, 'activo', 1),
(21, 'Leche', '', 'l', 1, '2026-01-31', 100, 300, 16, 'activo', 2),
(22, 'Fecula de Maiz', '', 'kg', 0, NULL, 120, 150, 26, 'activo', 1),
(23, 'Huevos', '', 'un', 1, '2025-12-31', 60, 12, 29, 'activo', 2),
(30, 'Azucar', '', 'kg', 0, NULL, 120, 119, 28, 'activo', 1),
(32, 'Leche en polvo', '', 'kg', 0, NULL, 100, 15, 16, 'activo', 1),
(33, 'Manteca', '', 'kg', 1, '2026-02-28', 50, 45, 31, 'activo', 2),
...
(43, 'Manteca', '1234', 'kg', 1, '2025-10-30', 20, 14, 16, 'activo', 2);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pedidomp`
--
...
--
-- Volcado de datos para la tabla `pedidomp`
--
...
--
-- Estructura de tabla para la tabla `pedidoventa`
--
...
CREATE TABLE IF NOT EXISTS `pedidoventa` (
  ...
  KEY `fk_pedidoventa_cliente` (`idCliente`),
  KEY `fk_pedidoventa_estado` (`estado`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Volcado de datos para la tabla `pedidoventa`
--

INSERT INTO `pedidoventa` (`idPedidoVenta`, `idCliente`, `fechaPedido`, `estado`, `observaciones`, `total`) VALUES
(8, 1, '2025-12-06 00:00:00', 70, '', 126000.00),
(9, 8, '2025-12-06 00:00:00', 80, '', 37500.00),
(10, 8, '2025-12-06 00:00:00', 70, '', 27000.00),
(11, 9, '2025-12-06 00:00:00', 100, '', 2750.00),
(12, 1, '2025-12-08 00:00:00', 70, '', 45500.00),
(13, 2, '2025-12-08 00:00:00', 100, '', 17500.00),
(14, 2, '2025-12-09 00:00:00', 100, '', 3500.00),
(15, 10, '2025-12-11 00:00:00', 100, '', 21000.00),
(16, 11, '2025-12-11 00:00:00', 100, '', 9500.00),
(17, 2, '2025-12-11 00:00:00', 90, '', 8500.00);
...
CREATE TABLE IF NOT EXISTS `producto` (
  ...
  KEY `fk_producto_cat` (`categoriaProd`)
...
(8, 'Pizza', 3, 'unid', NULL, 3500.00, '2025-12-08 16:38:27', 'Activo');
...
CREATE TABLE IF NOT EXISTS `reparto` (
  ...
  KEY `idx_reparto_vehiculo` (`idVehiculo`)
...
INSERT INTO `reparto` (`idReparto`, `fechaReparto`, `horaSalida`, `horaInicioReal`, `horaFinReal`, `zona`, `idVehiculo`, `estado`, `observaciones`, `eliminado`) VALUES
(2, '2025-12-09', '17:00:00', NULL, NULL, 'Zona Oeste', 1, 'Finalizado', NULL, 0),
(3, '2025-12-10', NULL, NULL, '13:11:08', 'Sur', 1, 'Finalizado', NULL, 0),
(4, '2025-12-11', '09:00:00', '13:11:13', '13:30:10', 'SUR', 3, 'Finalizado', NULL, 0);
...
--
-- Estructura de tabla para la tabla `solicitudes_turno`
--
...
CREATE TABLE IF NOT EXISTS `solicitudes_turno` (
  ...
  KEY `idx_asignacion` (`idAsignacion`),
  KEY `idx_empleado` (`idEmpleado`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Volcado de datos para la tabla `solicitudes_turno`
--
...
(3, 10, 11, 'Rechazo', 'Cumple años mi perrito', 'Aprobada', '2025-12-08 16:34:56', '2025-12-08 16:35:28', NULL),
(4, 9, 11, 'Cambio', 'no puedo', 'Pendiente', '2025-12-08 16:49:46', NULL, NULL),
(5, 11, 12, 'Rechazo', 'voy a estar enfermo ;)', 'Aprobada', '2025-12-11 11:16:13', '2025-12-11 11:16:36', NULL),
(6, 12, 12, 'Cambio', 'Favor de moverme al turno noche', 'Aprobada', '2025-12-11 11:23:11', '2025-12-11 11:26:39', NULL);
...
--
-- Estructura de tabla para la tabla `turnoslaborales`
--

DROP TABLE IF EXISTS `turnoslaborales`;
CREATE TABLE IF NOT EXISTS `turnoslaborales` (
...
--
-- Volcado de datos para la tabla `turnoslaborales`
--
...
(29, 'pvarela', '25d55ad283aa400af464c76d713c07ad', '2025-12-06 18:17:23', 'Pedro Varela', 'Activo', 0, NULL, 10),
(30, 'bsanchez', '25d55ad283aa400af464c76d713c07ad', '2025-12-11 11:14:24', 'Beatriz Sanchez', 'Activo', 0, NULL, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `vacaciones_config`
--
...
--
-- Volcado de datos para la tabla `vacaciones_config`
--
...
CREATE TABLE IF NOT EXISTS `vehiculo` (
  ...
  `capacidadKg` decimal(10,2) DEFAULT NULL,
  `idChofer` int NOT NULL,
  `estado` enum('Activo','Inactivo') NOT NULL DEFAULT 'Activo',
  `eliminado` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idVehiculo`),
  UNIQUE KEY `uq_vehiculo_patente` (`patente`),
  KEY `idx_vehiculo_chofer` (`idChofer`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `vehiculo` (`idVehiculo`, `patente`, `descripcion`, `marca`, `modelo`, `anio`, `capacidadKg`, `idChofer`, `estado`, `eliminado`) VALUES
(1, 'AA123AA', 'Camioneta 1', 'Citroen', 'Jumpy', 2019, 1800.00, 15, 'Activo', 0),
(3, 'AA789CD', 'Vehiculo zona sur', 'Renault', 'Kangoo', 2015, 850.00, 15, 'Activo', 0);
...
--
-- Filtros para la tabla `detallereparto`
--
ALTER TABLE `detallereparto`
  ADD CONSTRAINT `fk_detallereparto_pedidoventa` FOREIGN KEY (`idPedidoVenta`) REFERENCES `pedidoventa` (`idPedidoVenta`),
  ADD CONSTRAINT `fk_detallereparto_reparto` FOREIGN KEY (`idReparto`) REFERENCES `reparto` (`idReparto`);

--
-- Filtros para la tabla `detalle_licencia`
--
...
--
-- Filtros para la tabla `pedidomp`
--
...
--
ALTER TABLE `reparto`
  ADD CONSTRAINT `fk_reparto_vehiculo` FOREIGN KEY (`idVehiculo`) REFERENCES `vehiculo` (`idVehiculo`);

--
-- Filtros para la tabla `solicitudes_turno`
--
...
ALTER TABLE `vehiculo`
  ADD CONSTRAINT `fk_vehiculo_chofer` FOREIGN KEY (`idChofer`) REFERENCES `empleados` (`id_empleado`);
COMMIT;
