...
(12, 12, '2025-12-22', '2025-12-26', 5),
(13, 13, '2025-12-22', '2025-12-26', 5);
...
(12, 11, 1, 4, '2025-10-28 11:25:44', '2025-10-28 11:31:44', NULL, 'Licencia por vacaciones', NULL, NULL, NULL),
(13, 11, 1, 3, '2025-10-28 11:35:13', '2025-10-28 11:40:55', NULL, 'Licencia por vacaciones', NULL, NULL, NULL);
...
(23, 'Huevos', '', 'un', 1, '2025-09-30', 60, 60, 29, 'activo', 2),
(30, 'Azucar', '', 'kg', 0, NULL, 120, 120, 28, 'activo', 1),
(32, 'Leche en polvo', '', 'kg', 0, NULL, 100, 120, 16, 'activo', 1),
(33, 'Manteca', '', 'kg', 0, NULL, 50, 35, 31, 'activo', 2),
...
(39, 'Dulce de Leche', '', 'kg', 1, '2025-10-20', 10, 8, 16, 'activo', 2),
...
INSERT INTO `pedidomp` (`idPedido`, `idProveedor`, `fechaPedido`, `Estado`) VALUES
(8, 16, '2025-07-04', 60),
(9, 25, '2025-07-04', 60),
(10, 16, '2025-07-04', 10),
(11, 16, '2025-07-04', 60),
...
(98, 25, '2025-06-12', 30),
(99, 27, '2025-01-07', 20),
(100, 31, '2024-12-31', 10),
(101, 28, '2025-02-10', 20),
(102, 27, '2025-05-17', 40),
(103, 31, '2025-05-16', 60),
(104, 29, '2025-03-17', 60),
(105, 29, '2025-02-23', 60),
(106, 16, '2025-01-20', 60),
(107, 29, '2025-04-11', 60),
(108, 28, '2025-04-09', 60),
(109, 28, '2025-01-10', 50),
(110, 16, '2025-01-22', 30),
(111, 29, '2025-05-24', 10),
(112, 26, '2024-12-26', 10),
(113, 26, '2024-12-21', 50),
(114, 31, '2025-01-22', 50),
(115, 31, '2025-05-04', 40),
(116, 29, '2025-01-18', 20),
(117, 27, '2025-01-18', 60),
(118, 16, '2025-06-20', 10),
(119, 28, '2025-07-29', 60),
(120, 29, '2025-07-30', 10),
(121, 16, '2025-07-30', 10),
(122, 16, '2025-10-12', 10);
...
(24, 'admin', '25d55ad283aa400af464c76d713c07ad', '2025-07-30 17:26:59', 'Carlos Admin', 'Inactivo', 0, NULL, NULL),
(25, 'Juan', '25d55ad283aa400af464c76d713c07ad', '2025-09-11 09:16:00', 'Juan Perez', 'Activo', 0, NULL, 8),
...
ALTER TABLE `categoriamp`
  MODIFY `idCatMP` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

ALTER TABLE `detallepedido`
  MODIFY `idDetallePedido` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=292;

ALTER TABLE `detalle_licencia`
  MODIFY `id_detalle` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

ALTER TABLE `empleados`
  MODIFY `id_empleado` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

ALTER TABLE `estados_licencia`
  MODIFY `id_estado` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

ALTER TABLE `estado_civil`
  MODIFY `id_estado_civil` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

ALTER TABLE `licencia`
  MODIFY `id_licencia` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

ALTER TABLE `licencia_cambios`
  MODIFY `id_cambio` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
ALTER TABLE `pedidomp`
  MODIFY `idPedido` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;

ALTER TABLE `proveedor`
  MODIFY `id_proveedor` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

ALTER TABLE `provincias`
  MODIFY `id_provincia` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

ALTER TABLE `puesto`
  MODIFY `idPuesto` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

ALTER TABLE `roles`
  MODIFY `id_rol` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

ALTER TABLE `tipos_licencia`
  MODIFY `id_tipo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
