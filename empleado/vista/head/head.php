...
<head>
  ...
  <style>
    ...
    .empleado-modulo .card {
      width: 100%;
      max-width: 900px;
      /* Ajustá a 840–960px si querés afinar */
      margin-left: auto;
      margin-right: auto;
      /* centra las tarjetas */
      padding-bottom: 20px;
    ...
    .empleado-modulo .tabla-empleados th {
      width: 240px;
      /* podés mover a 220/260 según lo veas */
      white-space: nowrap;
    }
    ...
    .empleado-modulo .datos-grid {
      ...
      gap: 10px 16px;
      margin-top: 15px;
      /* espacio entre encabezado y los primeros datos */
      margin-bottom: 10px;
    }
...
<!-- Botón flotante -->
  ...
  <div class="barra-lateral">
    ...
    <nav class="navegacion">
      <ul>
        <li>
          <a id="menuInicio" class="active" href="../../empleado/vista/index.php">
        ...
        <li>
          <a id="menuLicencias" href="../../licencias/vista/index.php">
        ...
        <li>
          <a id="menuTurnos" href="../../empleado/vista/mis_turnos.php">
        ...
        <li>
          <a id="menuReporteLic" href="../../licencias/vista/reporteMisLicencias.php">
        ...
        <li>
          <a id="menuVolver" href="/bakersoft/inicio.php">
